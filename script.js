...
const CONFIG = {
    ...
    textos: {
        cat1: { t: "CONÓCENOS", c: "Nacemos de la pasión por la perfección estética. En nuestro santuario, cada trazo y cada corte se ejecuta con la maestría de un artist, garantizando que tu imagen refleje la elegancia y el poder que llevas dentro. Somos más que un salón, somos tu aliado en la creación de una marca personal inolvidable.\n\nWe are born from a passion for aesthetic perfection. In our sanctuary, every stroke and cut is executed with master artistry, ensuring your image reflects elegance." },
        cat2: { t: "SERVICIOS EXCLUSIVOS", c: "Desde colorimetría avanzada que respeta la salud de tu fibra capilar, hasta diseños de corte vanguardistas. Nuestro equipo domina las tendencias globales de Balayage, tratamientos de reconstrucción profunda y estilismo para eventos de alto nivel. Aquí, la calidad no es un servicio, es nuestro estándar innegociable.\n\nFrom advanced hair coloring to cutting-edge designs. Deep reconstruction treatments and elite styling." },
